...
class Detector:
    ...
    def get_dets(self, img,conf_thresh = 0,det_classes = [0], resolution = (640, 448)):
...
def process_video(input_path, output_path, model_path, conf_thresh, cam_para_dir, det_classes):
    ...
    while True:
        ...
        dets = detector.get_dets(frame,conf_thresh, det_classes, resolution)
...
if __name__ == "__main__":
    args = parse_args()
    process_videos_in_folder(args.input, args.output, args.model, args.conf_thresh, args.cam_para_dir, args.det_classes)
